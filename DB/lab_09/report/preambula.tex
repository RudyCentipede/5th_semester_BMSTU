...
\newcommand{\ssr}[1]{\phantomsection\begin{center}
		\LARGE\bfseries{#1}
...
\lstset{ %
	...
	basicstyle=\small\ttfamily\upshape, % размер и начертание шрифта для подсветки кода
...
\usepackage{hyperref}
\hypersetup{
	pdfborder = {0 0 0} % Полностью убирает рамки
}
