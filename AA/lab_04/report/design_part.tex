...
На рисунках~\ref{alg:db1} --~\ref{alg:db3} представлена схема последовательного алгоритма DBSCAN.

\begin{figure}[h]
	\centering
	\includegraphics[scale=0.9]{images/dbscan_1.pdf}
	\caption{Схема последовательного алгоритма DBSCAN (часть 1)}
	\label{alg:db1}
\end{figure}
...
\begin{figure}[h]
	...
	\caption{Схема последовательного алгоритма DBSCAN (часть 2)}
	\label{alg:db2}
\end{figure}
...
\begin{figure}[h]
	...
	\caption{Схема последовательного алгоритма DBSCAN (часть 3)}
	\label{alg:db3}
\end{figure}
...
На рисунках~\ref{alg:db_prl1} --~\ref{alg:db_prl3} представлена схема параллельного алгоритма DBSCAN.


\begin{figure}[h]
	\centering
	\includegraphics[scale=0.9]{images/dbscan_prl_1.pdf}
	\caption{Схема параллельного алгоритма DBSCAN (часть 1)}
	\label{alg:db_prl1}
\end{figure}
...
\begin{figure}[h]
	...
	\caption{Схема параллельного алгоритма DBSCAN (часть 2)}
	\label{alg:db_prl2}
\end{figure}
...
\begin{figure}[h]
	...
	\caption{Схема параллельного алгоритма DBSCAN (часть 3)}
	\label{alg:db_prl3}
\end{figure}
